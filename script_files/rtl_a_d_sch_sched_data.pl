#!/router/bin/perl
## This script extracts RTL Stage A-D completion dates for SCH Blocks, converts the standard date format into # of days, 
...
my $txtfile = "rtl_a_d_sch_sched_data.txt";
