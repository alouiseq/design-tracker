#!/router/bin/perl
## This script extracts RTL Stage A-C completion dates for QPB Blocks, converts the standard date format into # of days, 
...
my @blk_buffer = `ls GIF*blk* OPM*blk* PBA*blk* QSM*blk* WRC*blk*`;
...
my $txtfile = "rtl_a_c_qpb_sched_data.txt";
