#!/router/bin/perl
## This script extracts RTL Stage A-D completion dates for QPB Blocks, converts the standard date format into # of days, 
...
my @blk_buffer = `ls GIF*blk* OPC*blk* OPL*blk* OPU*blk* PBA*blk* QSM*blk* WRC*blk*`;
...
my $txtfile = "rtl_a_d_qpb_sched_data.txt";
